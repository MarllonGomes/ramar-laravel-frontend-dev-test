 ...
 return (
      ...
      hover:border-blue-500">
            ...
            <div className='card-img flex items-center gap-4'>
              <img className='w-20 h-25 rounded-lg' src={brmotos} alt="BR Motos" />
            
            {/* <img src={seller.logo_url} alt="seller" /> */}
              <div className='list-items flex-inline'>
                 {seller.is_verified && (
                 <div className="flex items-center space-x-2 p-2 border-2 border-[#3B82F6] rounded-md">
                  ...
                  <path d="M5 0C2.24 0 0 2.24 0 5C0 7.76 2.24 10 5 10C7.76 10 10 7.76 10 5C10 2.24 7.76 0 5 0ZM4 7.5L1.5 5L2.205 4.295L4 6.085L7.795 2.29L8.5 3L4 7.5Z" fill="#3B82F6"/>
                   ...
                   <span className='text-[#3B82F6] font-inter font-semibold text-[8px] leading-none tracking-normal uppercase'>Revenda verificada</span>

                 </div>

                )}
                
                <p className="font-sora font-bold text-[22px] leading-none tracking-normal text-right">{seller.name}</p>
                  ...
                  <div className="localization">
                        ...
                        <span> BR/ {seller.name}</span>
                        </div>

                        <div className='flex items-center space-x-1 bg-[#E20025E5] text-white'>
                          <svg width="8" height="11" viewBox="0 0 8 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M4 0C1.78857 0 0 1.7215 0 3.85C0 6.7375 4 11 4 11C4 11 8 6.7375 8 3.85C8 1.7215 6.21143 0 4 0ZM4 5.225C3.21143 5.225 2.57143 4.609 2.57143 3.85C2.57143 3.091 3.21143 2.475 4 2.475C4.78857 2.475 5.42857 3.091 5.42857 3.85C5.42857 4.609 4.78857 5.225 4 5.225Z" fill="#111827"/>
                          </svg>
                          <p className='p-2 w-30 '>50 km</p>
                        </div>
                 
                </div>
              </div>
          </div>
            <div className="whats m-4 p-4 w-57 bg-[#16A34A] text-white flex items-center justify-center space-x-2 ">
            ...
            <a href={seller.external_url} className='p-4 bg-[#57534E]  text-white mt-2 rounded-lg mx-auto'>Veja as motos da revenda</a>
