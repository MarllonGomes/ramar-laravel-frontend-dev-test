    ...
    const handleLoadMore = () => {
        ...
        router.get(url, {page: nextPageState },{
            ...
            onSuccess: (page) => {
                const p = page as Page<PageProps>;
                setSellers(prev => {
                const newSellers = p.props.sellers.filter(
                    ns => !prev.some(ps => ps.id === ns.id)
                );
    ...
    return (
        <>
            ...
            <div className="container mx-auto ">
                <div className="card-select-button flex flex-col items-center justify-center ">
                    ...
                    <div className='items-center justify-center bg-white rounded-md shadow-md p-6 card-input'>
                        <div className='w-200 flex flex-col sm:flex-row sm:items-center sm:justify-between sm:gap-4'>
                    ...
                    <button className='mt-2 rounded-lg w-full bg-black text-white p-4 bg-[#1F2937]' type="button" onClick={handleConsult}>Consultar</button>
                </div>
                </div>
                ...
                <div className='  list-component'>
                    ...
                    <div className='flex justify-center'>
                        {hasMorePages && (
                        <button className=' rounded-lg bg-black text-white p-4 m-5' type="button" onClick={handleLoadMore}>Exibir mais</button>
                        )}
                    </div>
                </div>
            </div>
